...
export default async function SetupPage({ searchParams }) {
  ...
  if (step === 2) {
    return (
      <main className="app-shell profile-setup-shell">
        <SetupTop />
